...
namespace ScreenshotsVisualizer.Controls
{
    ...
    public partial class PluginListScreenshots : PluginUserControlExtend
    {
        ...
        {
            ControlDataContext.IsActivated = PluginDatabase.PluginSettings.EnableIntegrationShowPictures;
            ...
            ControlDataContext.IntegrationShowPicturesHeight = PluginDatabase.PluginSettings.IntegrationShowPicturesHeight;
